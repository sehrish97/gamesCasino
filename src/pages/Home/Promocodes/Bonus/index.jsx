      ...
      <Table size="small">
        <TableHead>
          <TableRow>
            ...
            <TableCell sx={{ borderBottom: "none" , fontSize:"16px",paddingBottom:"25px"}}>Needed to wager</TableCell>
        ...
        <TableBody>
          {rows.map((row, index) => (
            <TableRow  key={index}>
              ...
              <TableCell sx={{borderBottom:"none !important",fontSize:"14.4px",cursor:"pointer",paddingBottom:"25px"}}>x</TableCell>

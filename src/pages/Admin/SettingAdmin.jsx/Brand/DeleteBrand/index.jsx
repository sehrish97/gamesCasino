...
import { useDeleteBrandMutation } from "../../../../../redux/api/brand/brandApiSlice";
...
const DeleteBrand = ({ brand, onClose, dispatch }) => {
  ...
  const handleDelete = async () => {
    const { data } = await deleteBrand({ brandId: brand._id });
    if (data) {
      setOpen(!open);
      onClose();
      dispatch();

...
export const leadSourceApiSlice = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    createLeadSource: builder.mutation({
      ...
      async onQueryStarted(arg, { queryFulfilled }) {
        try {
          ...
          toast.success("LeadSource Successfully Created");
          return data;
        } catch (error) {
...
export const { useCreateLeadSourceMutation , useGetAllLeadSourceQuery } = leadSourceApiSlice;

...
import { useCreateBrandMutation } from "../../redux/api/brand/brandApiSlice";
          ...
          >
            {!!state.imgUrl ? (
              <Box sx={{ width: 200, height: 100 }}>
                <img src={typeof state.imgUrl === "object" && URL.createObjectURL(state.imgUrl)} alt="company icon" className="absolute inset-0 h-full w-full object-contain" />
              </Box>
            ) : (
            ...
            <TextField fullWidth id="standard-basic" label="Brand Title" variant="standard" onChange={(e) => dispatch({ title: e.target.value })} />
            <TextField fullWidth id="standard-basic" label="Brand Acroynm" variant="standard" onChange={(e) => dispatch({ acronym: e.target.value })} />
            <FormControl fullWidth variant="standard" sx={{ m: 1, minWidth: 120 }}>
              <InputLabel id="demo-simple-select-standard-label">Brand's Company</InputLabel>
              <Select
